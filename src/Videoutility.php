...
class Videoutility {
  ...
  public static function clearEntityCache($type, $id) {
    ...
    EntityManager::getStorageController($type)->resetCache(array($id));
    ...
    if (\Drupal::moduleHandler()->moduleExists('entitycache')) {
  ...
  public static function getDimensions() {
    ...
    $dims = explode("\n", str_replace("\r", '', \Drupal::config('video.settings')->get('video_dimensions') ?: self::getDefaultDimensions()));
