...
class videoTranscoderConfiguration extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['video_convertor'] = array(
      ...
      '#default_value' => \Drupal::config('video.settings')->get('video_convertor') ?: 'TranscoderAbstractionFactoryFfmpeg',
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    $video_convertor = \Drupal::config('video.settings')->get('video_convertor');
